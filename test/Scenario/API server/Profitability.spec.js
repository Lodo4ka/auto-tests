...
const buttonCreateReport = require("../../../utils/selectors.js")
  .buttonCreateReport;
let levelLogging = require("selenium-webdriver").logging.Type.BROWSER;
const residentUrl = require(path.relative("./", "../../../config/login.js"))
  .residentUrl;
...
describe("written moch data in form", function() {
  ...
  it("write moch data in profitability", function() {
    ...
    driver
      .wait(until.elementLocated(By.css(buttonCreateReport)), 20000)
    ...
    driver
      .wait(until.elementLocated(By.css(contrAgent)), 20000)
      .then(element => {
        return driver.wait(until.elementIsVisible(element), 20000);
      })
      .then(function(input) {
    ...
    driver
      .wait(until.elementLocated(By.name(contrDateFrom)), 20000)
      .then(element => {
        return driver.wait(until.elementIsVisible(element), 20000);
      })
      .then(input => {
    ...
    driver
      .wait(until.elementLocated(By.name(contrDateTo)), 20000)
      .then(element => {
        return driver.wait(until.elementIsVisible(element), 20000);
      })
      .then(input => {
