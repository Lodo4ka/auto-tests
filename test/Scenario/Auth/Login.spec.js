...
const password = require(path.relative("./", "../../../config/login.js"))
  .password;
...
describe("login into home page", function() {
  ...
  it("login into crm2", function(done) {
    ...
    driver
      .findElement(By.name(passInput))
      .sendKeys(password)
      .then(function() {});
    driver
      .findElement(By.css(submitBtn))
      .click()
      .then(function() {})
      .finally(done);
  });
  ...
  it("should receive values from session storage", function() {
    driver
      .executeScript("return window.sessionStorage.getItem('blockIsDisActive')")
